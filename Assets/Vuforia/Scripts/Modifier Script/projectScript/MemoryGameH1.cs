...
public class MemoryGameH1 : MonoBehaviour {

	public GameObject NextObjectH1;
	...
	dontClickF divDontClick;
	//bool destroyed = false;

	// Use this for initialization
	public void Start () {
		divDontClick = GameObject.Find ("clickDivf").GetComponent<dontClickF>();
	...
	public void ObjectOrgan(GameObject cardOrgan){
		if (divDontClick.divClick) {
			switch (cardOrgan.tag) {
			case "lambung":
				divDontClick.divClick = false;
				organT [0].SetActive (true);
